...
const CompanyDetail: React.FC<CompanyDetailProps> = ({
  ...
  const filterPeriodData = () => {
    return [
      ...
      },
      {
        periode: "2",
        monoTarget: (company2?.target2Percent ?? 0) / 4,
        monoAchievement: company2?.monokulturAchievements.IV,
        tsTarget: (company2?.target7Percent ?? 0) / 4,
        tsAchievement: company2?.tumpangSariAchievements.IV,
      },
      {
        periode: "3",
        monoTarget: (company3.target2Percent ?? 0) / 4,
        monoAchievement: company3.monokulturAchievements.II,
        tsTarget: (company3.target7Percent ?? 0) / 4,
        tsAchievement: company3.tumpangSariAchievements.II,
      },
      {
        periode: "4",
        monoTarget: (company2?.target2Percent ?? 0) / 4,
  ...
  const targetDistribution = [
    {
      name: "2% Monokultur",
      value: company3.target2Percent,
      fill: "hsl(var(--chart-1))",
    },
    {
      name: "7% Tumpang Sari",
      value: company3.target7Percent,
    ...
    },
    {
      ...
      value:
        company3.area -
        ((company3.target2Percent ?? 0) + (company3.target7Percent ?? 0)),
                ...
                <CardFooter className="flex-col gap-3">
                  ...
                  <div className="w-full grid grid-cols-1 gap-2">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {company3.target2Percent?.toLocaleString("id-ID", {
                          maximumFractionDigits: 2,
                        })}
                      </span>
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {company3.target7Percent?.toLocaleString("id-ID", {
                          maximumFractionDigits: 2,
                        })}
                      </span>
                    </div>
                  ...
                  <div className="w-full grid grid-cols-1 gap-2 pt-2 border-t">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-medium">
                        {(
                          company3.monokulturAchievements.II +
                          company3.tumpangSariAchievements.II +
                          (company3.csrAchievements.II ?? 0)
                        ).toLocaleString("id-ID", {
                          maximumFractionDigits: 2,
                        })}{" "}
                        dari{" "}
                        {(
                          (company3.target2Percent ?? 0) +
                          (company3.target7Percent ?? 0)
                        ).toLocaleString("id-ID", {
                          maximumFractionDigits: 2,
                        })}
                      </span>
                    ...
                    <CardFooter>
                      <div className="w-full pt-2 border-t">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">
                            {company3.monokulturAchievements.II.toLocaleString(
                              "id-ID",
                              {
                                maximumFractionDigits: 2,
                              }
                    ...
                    <CardFooter>
                      <div className="w-full pt-2 border-t">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">
                            {company3.tumpangSariAchievements.II.toLocaleString(
                              "id-ID",
                              {
                                maximumFractionDigits: 2,
                              }
                    ...
                    <CardFooter>
                      <div className="w-full pt-2 border-t">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">
                            {company4.monokulturAchievements.IV.toLocaleString(
                              "id-ID",
                              {
                                maximumFractionDigits: 2,
                              }
                            ...
                            dari{" "}
                            {company4.target2Percent?.toLocaleString("id-ID", {
                              maximumFractionDigits: 2,
                            })}
                          </span>
                        </div>
                    ...
                    <CardFooter>
                      <div className="w-full pt-2 border-t">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-medium">
                            {company4.tumpangSariAchievements.IV.toLocaleString(
                              "id-ID",
                              {
                                maximumFractionDigits: 2,
                              }
                            ...
                            dari{" "}
                            {company4.target7Percent?.toLocaleString("id-ID", {
                              maximumFractionDigits: 2,
                            })}
                          </span>
                        </div>
                  ...
                  <CardFooter>
                    <div className="w-full pt-2 border-t">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium">
                          {company3.csrAchievements.II.toLocaleString("id-ID", {
                            maximumFractionDigits: 2,
                          })}
                        </span>
                      </div>
                  ...
                  <CardFooter>
                    <div className="w-full pt-2 border-t">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-sm font-medium">
                          {company4.csrAchievements.IV.toLocaleString("id-ID", {
                            maximumFractionDigits: 2,
                          })}
                        </span>
                      </div>
